...
public class UserController extends HttpServlet {
    ...
    private void updateUser(HttpServletRequest request, HttpServletResponse response) throws
        ...
        try {
            User user = userService.updateUser(new User(id, username,status,role, phoneNumber, address,password));
    ...
    private void addUser(HttpServletRequest request, HttpServletResponse response) throws
        ...
        User newUser = new User(id, userName, AVAILABLE, Role.USER, phoneNumber, address, password);
        try {
    ...
    private void addAdmin(HttpServletRequest request, HttpServletResponse response) throws
        ...
        User newUser = new User(id, name, AVAILABLE, Role.ADMIN, phoneNumber, address, password);
        try {
            userService.addUser(newUser);
            request.setAttribute("message", "Customer information was created");
            request.setAttribute("classCss", "message success");
